...
class Events extends Component {
  state = {registrationStatus: 'INITIAL', activeId: ''}

  getStatus = (registrationStatus, activeId) => {
    this.setState({registrationStatus, activeId})
  }

  render() {
    const {registrationStatus, activeId} = this.state
    return (
